...
namespace Library.BooksDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = @"SELECT       ID, BookName, Owner, Translator, Publisher, Subject, Shabak, [Year], Picture
FROM            Books
WHERE        (BookName = ?) OR
                         (Owner = ?) OR
                         (Subject = ?) OR
            ...
            this._commandCollection[3].CommandText = "INSERT INTO `Books` (`BookName`, `Owner`, `Translator`, `Publisher`, `Subject`, `" +
                "Shabak`, `Year`, `Picture`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        public virtual BooksDataSet.BooksDataTable GetDataBy(string BookName, string Owner, string Subject, global::System.Nullable<int> Year) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((BookName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int UpdateQuery(string BookName, string Owner, string Translator, string Publisher, string Subject, string Shabak, global::System.Nullable<int> Year, string Picture, int Original_ID) {
